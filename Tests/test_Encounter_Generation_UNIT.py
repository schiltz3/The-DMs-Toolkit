...
from toolkit.models import Monster, Tag, GeneratedLoot, Armor, GenericItem, MagicItem, Weapon
django.setup()
...
class Tag_Tests(TestCase):
    ...
    def test_get_tags_positive(self):
        self.encounter.tags.append(self.new_tag)
        self.assertIn(self.new_tag, self.encounter.get_tags(), msg="Tag not in the list")
    def test_add_tags_negative(self):
        ...
        with self.assertRaises(ValueError, msg = "Should not accept a nonstring tag name"):
            self.encounter.add_tag(1)
        with self.assertRaises(ValueError, msg = "Should not accept a tag not in the database"):
...
class Monsters_And_CR_Tests(TestCase):
    def setUp(self):
        ...
        self.mon1 = Monster(Name = "Fred", Description = "A guy", Challenge_Rating = 2.0,
                            Strength = 1, Dexterity = 1, Constitution = 1, Intelligence = 1, Wisdom = 1, Charisma = 1)
        self.mon2 = Monster(Name = "Demon", Description = "A demon", Challenge_Rating = 10.0,
                            Strength = 1, Dexterity = 1, Constitution = 1, Intelligence = 1, Wisdom = 1, Charisma = 1)
        self.mon1.save()
        self.mon2.save()
...
class Generate_Test(TestCase):
    def setUp(self):
        ...
        self.mon1 = Monster(Name = "Fred", Description = "A guy", Challenge_Rating = 2.0,
                            Strength = 1, Dexterity = 1, Constitution = 1, Intelligence = 1, Wisdom = 1, Charisma = 1, Gold_Modifier = 1)
        
        self.mon2 = Monster(Name = "Demon", Description = "A demon", Challenge_Rating = 10.0,
                            Strength = 1, Dexterity = 1, Constitution = 1, Intelligence = 1, Wisdom = 1, Charisma = 1, Gold_Modifier = 10)
        self.mon1.save()
        self.mon2.save()
