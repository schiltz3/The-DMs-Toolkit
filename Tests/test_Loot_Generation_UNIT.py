...
class PositiveTests(TestCase):
    ...
    def test_generic(self):
        ...
        item = GenericItem(Name = "Rope",
        Description = "It's Rope",
        Base_Value = .01)
        item.save()
...
class negative_tests(TestCase):
    ...
    def test_generate(self):
        ...
        new_loot = Loot_Gen.Loot_Generator()
        with self.assertRaises(ValueError, msg="Shouldn't accept that as a generator key"):
